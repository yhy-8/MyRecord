...
client/                  客户端薄端（独立工程，见 client/README.md）
  ...
  sync.py                实时同步（push/离线队列/拉取/长轮询扇出/报告同步）
  cli/                   交互界面与命令
...
客户端会自动：写后即时 push、每 1 分钟拉取对账、长轮询接收扇出、把云端报告同步到本地
`AnalysisReports/`。
...
- [`Docs/设计原则与系统架构.md`](./Docs/设计原则与系统架构.md)
- [`Docs/Agent与报告流程.md`](./Docs/Agent与报告流程.md)
- [`Docs/运行机制与数据.md`](./Docs/运行机制与数据.md)
- [`Docs/重构计划与功能说明.md`](./Docs/重构计划与功能说明.md)

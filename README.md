...
| 关键设计（安全/加密/日志/AI 审核） | [`Docs/安全、通信与日志.md`](./Docs/安全、通信与日志.md) | 强制 TLS、连接凭证、服务端日志内容、AI 工具/审核链、报告来源标注设计 |
...
- [`Docs/安全、通信与日志.md`](./Docs/安全、通信与日志.md) — 关键设计说明：强制加密、连接凭证、服务端日志内容、AI 审核链、报告来源标注
